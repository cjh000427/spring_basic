...
<script>
    ...
    window.onload = function() {
        ...
        document.getElementById('replyRegist').onclick = function() {
            ...
            fetch('${pageContext.request.contextPath}/relpy/regist', reqObj)
                .then(res => res.text())
                    .then(data => {
                        console.log('통신 성공!: ' + data);
                        document.getElementById('relpy').value = '';
                        document.getElementById('relpyId').value = '';
                        document.getElementById('relpyPw').value = '';
        ...
        function getList(pageNum, reset) {
            ...
            fetch('${pageContext.request.contextPath}/relpy/getList/' + bno + '/' + pageNum)
                .then()
